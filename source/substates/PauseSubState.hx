...
class PauseSubState extends MusicBeatSubstate
{
	...
	override function create()
	{
		...
		levelInfo.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 32);
		levelInfo.updateHitbox();
		add(levelInfo);

		var levelDifficulty:FlxText = new FlxText(20, 15 + 32, 0, Difficulty.getString().toUpperCase(), 32);
		levelDifficulty.scrollFactor.set();
		levelDifficulty.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 32);
		...
		blueballedTxt.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 32);
		blueballedTxt.updateHitbox();
		add(blueballedTxt);

		practiceText = new FlxText(20, 15 + 101, 0, Language.getPhrase("Practice Mode").toUpperCase(), 32);
		practiceText.scrollFactor.set();
		practiceText.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 32);
		...
		chartingText.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 32);
		...
		missingText.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 24, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
	...
	function regenMenu():Void {
		...
		for (num => str in menuItems) {
			...
			if(str == 'Skip Time')
			{
				...
				skipTimeText.setFormat(Paths.font(PlayState.instance.uiData.font + ".ttf"), 64, FlxColor.WHITE, CENTER, FlxTextBorderStyle.OUTLINE, FlxColor.BLACK);
