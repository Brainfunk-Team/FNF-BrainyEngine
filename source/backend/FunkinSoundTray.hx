...
//taken from Funkin source code lol
...
class FunkinSoundTray extends FlxSoundTray
{
  ...
  public function new()
  {
    ...
    var bg:Bitmap = new Bitmap(Assets.getBitmapData(Paths.getSharedPath() + "images/soundtray/volumebox.png"));
    ...
    var backingBar:Bitmap = new Bitmap(Assets.getBitmapData(Paths.getSharedPath() + "images/soundtray/bars_10.png"));
    backingBar.x = 9;
    backingBar.y = 5;
    ...
    for (i in 1...11)
    {
      var bar:Bitmap = new Bitmap(Assets.getBitmapData(Paths.getSharedPath() + "images/soundtray/bars_" + i + ".png"));
      bar.x = 9;
      bar.y = 5;
    ...
    volumeUpSound = Paths.getSharedPath() + "sounds/soundtray/Volup.ogg";
    volumeDownSound = Paths.getSharedPath() + "sounds/soundtray/Voldown.ogg";
    volumeMaxSound = Paths.getSharedPath() + "sounds/soundtray/VolMAX.ogg";
  }
  ...
  function getGlobalVolume(up:Bool = false):Int
  {
    ...
    trace("ROUNDED VOLUME: " + globalVolume);
