...
class CreditsState extends MusicBeatState
{
	...
	override function create()
	{
		...
		var defaultList:Array<Array<String>> = [ //Name - Icon name - Description - Link - BG Color
			["Brainy Engine Team"],
			["Brainy7890", "brainy7890", "Main Programmer, Composer, Head of Brainy Engine.", "https://github.com/Brainfunk-Team/FNF-BrainyEngine", "ffc051"],
			["OfficialGamer", "official", "Developer, Windows Builds, Sounds, etc", "https://officialgamer.nekoweb.org", "fca103"],
			[""],
			["Contributors"],
			["Nobody", "missing_icon", "Contribute now!", "https://github.com/Brainfunk-Team/FNF-BrainyEngine", "b5b5b5"],
			[""],
			["Psych Engine Team"],
